...
public class CommonUtils {
    ...
    public static String formatDate(String string, Context context) {
        ...
        if (diff > year) {
            r = (diff / year);
            if (r == 1) {
                return r + " " + context.getResources().getString(R.string.year);

            } else {
                return r + " " + context.getResources().getString(R.string.years);
            }

        } else if (diff > month) {
            r = (diff / month);
            if (r == 1) {
                return r + " " + context.getResources().getString(R.string.month);

            } else {
                return r + " " + context.getResources().getString(R.string.months);
            }
        } else if (diff > day) {
            r = (diff / day);
            if (r == 1) {
                return r + " " + context.getResources().getString(R.string.day);

            } else {
                return r + " " + context.getResources().getString(R.string.days);
            }
        } else if (diff > hour) {
            r = (diff / hour);
            if (r == 1) {
                return r + " " + context.getResources().getString(R.string.hour);

            } else {
                return r + " " + context.getResources().getString(R.string.hours);
            }
        } else if (diff > minute) {
            r = (diff / minute);
            if (r == 1) {
                return r + " " + context.getResources().getString(R.string.minute);

            } else {
                return r + " " + context.getResources().getString(R.string.minits);
            }
    ...
    public static String getLikeCount(long likeCount) {
